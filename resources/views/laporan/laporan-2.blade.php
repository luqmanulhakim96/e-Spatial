      ...
      <!--Page Body part -->
            <div class="page-body p-4 text-dark">
                ...
                <div class="card rounded-lg" style="border-color: #003473 !important;">
                  <div class="card-header" style="text-align:center; border-color: #003473 !important; font-size: 130%; font-weight: bold;">Laporan Bilangan Permohonan Mengikut Kategori Pemohon</div>

                  <div class="card-body">

                      <form class="" action="{{ route('laporan.laporan-2-tapis') }}" method="post">
                        @csrf
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <a href="{{ route('laporan.laporan-2') }}" class="btn btn-primary m-auto"><i class="fa fa-refresh" aria-hidden="true"></i> Reset</a>
                        </div>
                      </div>
                      ...
                      <table class="table table-striped table-bordered" id="table-laporan" style="width: 100%;">
                        <thead>
                            <tr>
                              ...
                              <th class="all">AGENSI PEMOHON</th>
                            </tr>
                        </thead>
                        <tbody>
                          @foreach($listPermohonan as $laporan2)
                          <tr>
                            <td></td>
                            <td>
        ...
        var t = $(tablelaporan).DataTable({
          ...
          "buttons": [
              'excel',
              {
                  ...
                  pageSize: 'A4',
                  title: 'Laporan Bilangan Permohonan Mengikut Kategori Pemohon',
              },
              {
                  extend: 'print',
                  text: 'Cetak',
