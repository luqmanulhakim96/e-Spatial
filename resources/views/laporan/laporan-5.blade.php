      ...
      <!--Page Body part -->
            <div class="page-body p-4 text-dark">
                ...
                <div class="card rounded-lg" style="border-color: #003473 !important;">
                  <div class="card-header" style="text-align:center; border-color: #003473 !important; font-size: 130%; font-weight: bold;">Laporan Mengikut Kategori Data Yang Diluluskan</div>

                  <div class="card-body">

                      <form class="" action="{{ route('laporan.laporan-5-tapis') }}" method="post">
                        @csrf
                        <div class="row pb-2">
                          <div class="col-md-1">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <a href="{{ route('laporan.laporan-5') }}" class="btn btn-primary m-auto"><i class="fa fa-refresh" aria-hidden="true"></i> Reset</a>
                        </div>
                      </div>
        ...
        var t = $(tablelaporan).DataTable({
          ...
          "buttons": [
              'excel',
              {
                  ...
                  pageSize: 'A4',
                  title: 'Laporan Mengikut Kategori Data Yang Diluluskan',
              },
              {
                  extend: 'print',
                  text: 'Cetak',
