      ...
      <!--Page Body part -->
            <div class="page-body p-4 text-dark">
                ...
                <div class="card rounded-lg" style="border-color: #003473 !important;">
                  <div class="card-header" style="text-align:center; border-color: #003473 !important; font-size: 130%; font-weight: bold;">Laporan Mengikut Kategori Data Yang Dipohon</div>

                  <div class="card-body">

                      <form class="" action="{{ route('laporan.laporan-3-tapis') }}" method="post">
                        @csrf
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <a href="{{ route('laporan.laporan-3') }}" class="btn btn-primary m-auto"><i class="fa fa-refresh" aria-hidden="true"></i> Reset</a>
                        </div>
                      </div>
                    ...
                    <div style="padding:10px;"></div>
                      ...
                      <table class="table table-striped table-bordered" id="table-laporan" style="width: 100%;">
                        ...
                        <tbody>
                          @foreach($data_permohonan as $laporan3)
                          <tr>
                            <td></td>
                            <td>
                              <div style="padding : 4px;"></div>
                              {{ $laporan3->permohonan->getPermohonanID()  }}
                            </td>
                            <td>
                              <div style="padding : 4px;"></div>
                              @if($laporan3->permohonan->tarikh_permohonan != null)
                              {{ Carbon\Carbon::parse($laporan3->permohonan->tarikh_permohonan)->format('d-m-Y ') }}
                              @else
                              -
                              @endif
                            </td>
                            ...
                            <td>
                              <div style="padding : 4px;"></div>
                              {{$laporan3->permohonan->user->name}}
                            </td>
                            <td>
                              <div style="padding : 4px;"></div>
                              {{$laporan3->harga->jenis_dokumen}}

                            </td>

                            @if($laporan3->harga->jenis_data == 'Lain-Lain')
                            <td>
                              <div style="padding : 4px;"></div>
                              {{$laporan3->harga->jenis_data}} - {{$laporan3->custom_jenis_data}}
                            </td>
                            <td>
                              <div style="padding : 4px;"></div>
                              {{$laporan3->harga->jenis_data}} - {{$laporan3->custom_tahun}}
                            </td>
                            @else
                            <td>
                              <div style="padding : 4px;"></div>
                              {{$laporan3->harga->jenis_data}}
                            </td>
                            @if($laporan3->harga->jenis_data == 'Petak Kajian')
                            <td>
                              <div style="padding : 4px;"></div>
                              {{$laporan3->harga->kategori_data}}
                            </td>
                            @else
                            <td>
                              <div style="padding : 4px;"></div>
                              {{$laporan3->harga->tahun}}
                            </td>
                            @endif
        ...
        var t = $(tablelaporan).DataTable({
          ...
          "buttons": [
              'excel',
              {
                  ...
                  pageSize: 'A4',
                  title: 'Laporan Mengikut Kategori Data Yang Dipohon',
              },
              {
                  extend: 'print',
                  text: 'Cetak',
