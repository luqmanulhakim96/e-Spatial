                                                  ...
                                                  <table class="table table-striped table-bordered" id="list_permohonan_lulus" style="width: 100%;">
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td><span class="badge badge-success badge-pill" style="font-size: 100%;">{{ $lulus->status_permohonan  }}</span></td>
                                                        ...
                                                        <td><span class="badge badge-primary badge-pill" style="font-size: 100%;">{{ $lulus->status_pembayaran  }}</span></td>
                                                  ...
                                                  <table class="table table-striped table-bordered" id="list_permohonan_gagal" style="width: 100%;">
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td>Menunggu ulasan Ketua Pengarah</td>
                                                        @else
                                                        <td><span class="badge badge-danger badge-pill" style="font-size: 100%;">{{ $baru2->status_permohonan  }}</span></td>
                                                        @endif
