                      ...
                      <div class="row">
                        <div class="col-md">
                          <div class="card-header" style="text-align: justify; text-justify: inter-word; border: 1px solid black;">
                            <h6 >Catatan:</h6>
                            <span>Sekiranya permohonan tersenarai dalam permohonan tidak berkaitan, permohonan data anda berkemungkinan tidak ada dalam senarai. Sila buat permohonan semula atau menghubngi pihak JPSM.</span><br>
