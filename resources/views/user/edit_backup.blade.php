      ...
      <!--Page Body part -->
            <div class="page-body p-4 text-dark">
                ...
                <div class="card rounded-lg">
                  <div class="card-body">
                      <div class="card-title">Edit Permohonan (Current ID: {{$info->id}})</div>
                          ...
                          <div class="col-md-15 mt-1">
                              ...
                              <div class="card rounded-lg">
                                          ...
                                          <table class="table table-bordered" id="pilihan_table">
                                              ...
                                              <tbody>
                                                ...
                                                @foreach($senaraiHarga[$i] as $senarai_harga_data)
                                                  <tr>
                                                    <td>
                                                      <p class="mb-0 font-weight-bold">{{$senarai_harga_data->jenis_dokumen}}</p>
                                                    </td>
                                                    @if($senarai_harga_data->jenis_dokumen == 'Bercetak')
                                                    <td>
                                                      <p class="mb-0 font-weight-bold">{{$senarai_harga_data->jenis_kertas}}</p>
                                                    </td>
                                                    @else
                                                    <td>
                                                      <p class="mb-0 font-weight-bold">Tiada</p>
                                                    </td>
                                                    @endif
                                                    <td>
                                                      <p class="mb-0 font-weight-bold">{{$senarai_harga_data->jenis_data}}</p>
                                                    </td>
                                                    <td>
                                                      <p class="mb-0 font-weight-bold">{{$senarai_harga_data->tahun}}{{$senarai_harga_data->kategori_data}}</p>
                                                    </td>
                                                    <td>
                                                      <p class="mb-0 font-weight-bold">{{$senarai_harga_data->negeri}}</p>
                                                    </td>
                                                    <td>
                                  ...
                                  <form  id="permohonan_data" action="{{route('user.update', $info->id)}}" method="post">
                                    ...
                                    @for( $i=0; $i < $jumlahdata; $i++)
                                    <div class="">
                                      <input type="text" id="data_permohonan{{$i}}" name="data[{{$i}}]" value="{{$dataPilihan[$i]->senarai_harga_id}}" readonly>
                                    </div>
                                    @endfor
                                  </form>
