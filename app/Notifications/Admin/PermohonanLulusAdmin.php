...
use App\Mail\Admin\EmailNotifikasiAdminLulus;
use Illuminate\Support\Facades\Mail;

class PermohonanLulusAdmin extends Notification
{
    use Queueable;
    ...
    {
      return Mail::queue(new EmailNotifikasiAdminLulus($this->admin, $this->email));
    }
